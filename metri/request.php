	  ...
	  <div class="col-sm-3">
	    ...
	    <div class="col-sm-6">
		   ...
		   <div class="buttons">
			   ...
			   <div class="vertical">Accept</div>
			   <div class="vertical">Decline</div>   
		   </div>
	    </div>
...
<?php
        $s= mysql_query("select * from `matrimonial`.`match` where `to_code`='$to_code' AND status='1'");
       while($sr=mysql_fetch_array($s)){
           $from_code= $sr['from_code'];
           $q=mysql_query("select * from matri where code='$from_code'");
	  ...
	  <div class="col-sm-3">
	    ...
	    <div class="col-sm-6">
		   ...
		   <div class="buttons">
               ...
               <a href="Accept_handler.php?from_code=<?php echo $qr['code'];?>">
                   <div class="vertical">Accept</div></a>
               <a href="Remove_Request.php?to_code=<?php echo $qr['code'];?>">
                   <div class="vertical">Decline</div></a>   
		   </div>
	    </div>
	    <div class="clearfix"> </div>
    </div>
