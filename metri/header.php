		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
		        <ul class="nav navbar-nav nav_1">
		            <li><a href="view_profile.php">Home</a></li>
		    		...
		    		<li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                ...
		                <li><a href="sentRequest.php">Sent Request</a></li>
						<li><a href="profile.php">Recently Viewed Profiles</a></li>
		                <li><a href="viewed_profile.php">Who Viewed my Profile</a></li>
		                <li><a href="shortlist.php">Shortlisted Profile</a></li>
		              </ul>
		            </li>
					<li class="dropdown">
					...
					<li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
					    <li class="last"><a href="edit_profile.php">Edit profile</a></li>
