...
include 'connection.php';
 //$sql=mysql_query("select * from matri");
   $from_code="";
   $rs=mysql_query("select * from matri where email='$user'");
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Shortlisted</li>
     </ul>
   </div>
...
<?php
        $s= mysql_query("select DISTINCT(to_code) from shortlist where from_code='$from_code'");
	    	...
	    	<table class="table_working_hours">
				...
				<h2><?php echo $qr['name']; ?></h2>
				    <tr class="opened">
						...
						<td class="day_value"><?php echo $qr['status'];?></td>
					</tr>
				    <tr class="closed">
						<td class="day_label1">Caste :</td>
						<td class="day_value closed"><span><?php echo $qr['caste'];?></span></td>
					</tr>
				    <tr class="closed">
						<td class="day_label1">Education :</td>
						<td class="day_value closed"><span><?php echo $qr['education'];?></span></td>
					</tr>
			    </tbody>
		   </table>
		   <div class="buttons">
                <a href="shortlist_remove_handler.php?to_code=<?php echo $qr['code'];?>">
                    <div class="vertical">Remove</div></a>
               <a href="interest.php?to_code=<?php echo $qr['code'];?>">
